    ...
    public static void updatePlayer(Player player) {
        if (player.iDMark.isLoadedAllDataPlayer()) {
            ...
            try {
                ...
                String query2 = "update account set active =? where id =? ";
                String query = " update player set data_item_time = ?, head = ?, have_tennis_space_ship = ?,"
                ...
                GirlkunDB.executeUpdate(query2, player.getSession().actived ? 1 : 0, player.getSession().userId);
